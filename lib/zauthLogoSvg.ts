/** Zauth mark — same markup as `public/favicon.svg` (for “Copy SVG” in docs). */
export const ZAUTH_LOGO_SVG = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
